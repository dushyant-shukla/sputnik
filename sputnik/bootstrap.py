...
SRC_DIR_BASE = "externals"
ARCHIVE_DIR_BASE = "archives"
SNAPSHOT_DIR_BASE = "snapshots"

BASE_DIR = os.getcwd()
# BASE_DIR = os.path.join(BASE_DIR, "sputnik")
SRC_DIR = os.path.join(BASE_DIR, SRC_DIR_BASE)
ARCHIVE_DIR = os.path.join(BASE_DIR, SRC_DIR_BASE, ARCHIVE_DIR_BASE)
SNAPSHOT_DIR = os.path.join(BASE_DIR, SRC_DIR_BASE, SNAPSHOT_DIR_BASE)
