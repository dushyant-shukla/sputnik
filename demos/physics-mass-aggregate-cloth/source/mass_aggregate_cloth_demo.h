...
class MassAggregateClothDemoLayer : public core::Layer
{

public:
    MassAggregateClothDemoLayer(const std::string& name);
    virtual ~MassAggregateClothDemoLayer();
...
class MassAggregateClothDemo : public sputnik::main::Application
{

public:
    MassAggregateClothDemo(const std::string& name) : sputnik::main::Application(name)
    {
        PushLayer(std::make_shared<MassAggregateClothDemoLayer>(name));
    }

    ~MassAggregateClothDemo() {}
};
...
{
    return new sputnik::demos::MassAggregateClothDemo("MAD Cloth Demo");
}
