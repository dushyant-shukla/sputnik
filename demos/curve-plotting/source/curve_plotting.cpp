...
sputnik::api::animation::ScalarFrame CurvePlotting::MakeFrame(float time, float value)
{
    return MakeFrame(time, 0.0f, value, 0.0f);
}

sputnik::api::animation::ScalarFrame CurvePlotting::MakeFrame(float time, float in, float value, float out)
{
    sputnik::api::animation::ScalarFrame result;
    result.m_time            = time;
...
sputnik::api::animation::VectorFrame CurvePlotting::MakeFrame(float time, const ramanujan::Vector3& value)
{
    return MakeFrame(time, ramanujan::Vector3(), value, ramanujan::Vector3());
}

sputnik::api::animation::VectorFrame CurvePlotting::MakeFrame(float                     time,
                                                              const ramanujan::Vector3& in,
                                                              const ramanujan::Vector3& value,
                                                              const ramanujan::Vector3& out)
{
    sputnik::api::animation::VectorFrame result;
    result.m_time            = time;
...
sputnik::api::animation::QuaternionFrame CurvePlotting::MakeFrame(float time, const ramanujan::Quaternion& value)
{
    return MakeFrame(time, ramanujan::Quaternion(0, 0, 0, 0), value, ramanujan::Quaternion(0, 0, 0, 0));
}

sputnik::api::animation::QuaternionFrame CurvePlotting::MakeFrame(float                        time,
                                                                  const ramanujan::Quaternion& in,
                                                                  const ramanujan::Quaternion& out,
                                                                  const ramanujan::Quaternion& value)
{
    sputnik::api::animation::QuaternionFrame result;
    result.m_time            = time;
    result.m_in_tangents[0]  = in.x;
    result.m_in_tangents[1]  = in.y;
    result.m_in_tangents[2]  = in.z;
