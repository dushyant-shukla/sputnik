...
class MassSpringRopeDemoLayer : public core::Layer
{

public:
    MassSpringRopeDemoLayer(const std::string& name);
    virtual ~MassSpringRopeDemoLayer();
...
class MassSpringRopeDemo : public sputnik::main::Application
{

public:
    MassSpringRopeDemo(const std::string& name) : sputnik::main::Application(name)
    {
        PushLayer(std::make_shared<MassSpringRopeDemoLayer>(name));
    }
...
{
    return new sputnik::demos::MassSpringRopeDemo("Mass Spring Rope Demo");
}
