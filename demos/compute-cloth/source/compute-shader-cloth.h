...
private:
    ...
    std::shared_ptr<OglTexture2D> m_color_texture;
    std::shared_ptr<OglTexture2D> m_normal_texture;
    std::shared_ptr<OglTexture2D> m_opacity_texture;

    std::shared_ptr<OglShaderProgram> m_compute_integration_shader;
    std::shared_ptr<OglShaderProgram> m_compute_normal_shader;
    std::shared_ptr<OglShaderProgram> m_cloth_shader;
    std::shared_ptr<OglShaderProgram> m_particles_shader;
};
