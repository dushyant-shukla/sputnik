...
include "demos/loading-animation-clips/loading-animation-clips.lua"
include "demos/cpu-skinning/cpu-skinning.lua"
include "demos/gpu-skinning/gpu-skinning.lua"
group ""
